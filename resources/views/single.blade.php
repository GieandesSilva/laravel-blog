            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" style="max-width:100px; border-radius: 50%">
                    </div>
                    ...
                    <div class="blog-details-author-content">
                        ...
                        <div class="socials">
                            ...
                            <a href="{{ $post->user->profile->linkedin }}" target="blank_" class="social__item">
                                <img src="{{ asset('app/svg/linkedin.svg') }}" alt="linkedin">
                            </a>
